...
Create a new folder: src/main/resources/css
...
CSS
/* 1. Import all of Tailwind's core styles */
@import "tailwindcss";
...
/* 4. (Optional) Add your own custom base styles */
@layer base {
  h1 {
...
1. Terminal 1 (Tailwind Watcher): In your project root, run this command. It will watch your input.css and .html files for changes and automatically rebuild style.css every time you save.
Bash
npm run watch-css
2. Terminal 2 (Spring Boot): In a separate terminal (or your IDE), run your Spring Boot application as usual.
